    ...
    <section id="about" className="py-20 bg-gray-800/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                specialize in creating beautiful, responsive, and performant web
                applications. My journey started with a curiosity about how
                websites work, and it has evolved into a passion for crafting
                exceptional digital experiences.
              </p>
              <p className="text-gray-300 leading-relaxed">
                I believe in writing clean, maintainable code and staying
                up-to-date with the latest technologies and best practices. When
                I'm not coding, you can find me exploring new design trends and
                ideas.
              </p>
            </div>
          ...
          {/* Right side - Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-6 animate-fade-in">
